...
rq3_choropleth_map <- function(dataRQ, color) {
  custom_palette <- colorNumeric(palette = color, domain = dataRQ$ratio, na.color = "lightgrey")
  
  map <- leaflet(dataRQ) %>%
    addProviderTiles(providers$CartoDB.Positron) %>%
    addPolygons(data = dataRQ %>% filter(type == 'overall'), 
                fillColor = ~custom_palette(ratio), 
                fillOpacity = 0.7,
                weight = 1, 
                opacity = 1, 
                dashArray = "5, 5", 
                ...
                label = ~paste(
                  ...
                  "n: ", n, "<br/>",
                  "Vaccinated:<span style='color: black; font-weight: bold;'>", round(ratio, 2), "%</span><br/>",
                  "</div>"
                ) %>% lapply(htmltools::HTML),
                group = "Overall") %>%
    addPolygons(data = dataRQ %>% filter(type == 'subgroup'), 
                fillColor = ~custom_palette(ratio), 
                fillOpacity = 0.7,
                weight = 1, 
                opacity = 1, 
    ...
    addLegend(
      ...
      pal = custom_palette, 
      values = ~dataRQ$ratio[!is.na(dataRQ$ratio)],
      title = "Vaccination (%)",
      labFormat = labelFormat(suffix = "%"),
      opacity = 1
    ) %>%
    addLayersControl(baseGroups = c("Subgroup", "Overall"),
...
rq4_choropleth_map <- function(dataRQ, color) {
  custom_palette <- colorNumeric(palette = color, domain = dataRQ$ratio, na.color = "lightgrey")
  ...
  map <- leaflet(dataRQ) %>%
    ...
    addPolygons(data = dataRQ %>% filter(type == 'overall'), 
                ...
                label = ~paste(
                  ...
                  "Name:<span style='color: green; font-weight: bold;'>", NUTS_NAME, "</span><br/>",
                  "n: ", n, "<br/>",
                  "Hospitalisation:<span style='color: black; font-weight: bold;'>", round(ratio, 2), "%</span><br/>",
                  "</div>"
                ) %>% lapply(htmltools::HTML),
                group = "Overall") %>%
    addPolygons(data = dataRQ %>% filter(type == 'subgroup'), 
...
rq3_gender_aggreg <- left_join(rq3_gender_aggreg, group)

rm(group)

rq3_gender_aggreg <- rq3_gender_aggreg %>%
  mutate(subgroup = n/nGroup,
         overall = n/individuals_nm)
...
rq4_gender_aggreg <- left_join(rq4_gender_aggreg, group)
...
rq4_gender_aggreg <- left_join(rq4_gender_aggreg, groupVacc)
...
rq4_gender_aggreg <- rq4_gender_aggreg %>% 
  left_join(groupUnVacc) %>% distinct()
...
rq4b_gender_aggregb <- rq4b_gender_aggreg %>%
  filter(fully_vaccinated_bl == FALSE) %>%
...
rq4_gender_aggreg <- bind_rows(rq4a_gender_aggreg, rq4b_gender_aggrega, rq4b_gender_aggregb)

rm(rq4a_gender_aggreg, rq4b_gender_aggreg, rq4b_gender_aggrega, rq4b_gender_aggregb)
...
Testing statistics, vaccination uptake and coverage, and hospitalisation will be assessed by age, gender, geographical region, target groups, and socioeconomic indicators.
...
plot_ly() %>%
  ...
  layout(title = "COVID-19 PCR tests distribution accross the cohort population",
         ...
         yaxis = list(title = "Percentage", tickformat = ',.0%'),  # This will format the hover text as percentages
         barmode = 'group')
...
rq1_2_age_group <- rq1_2_age_group %>% mutate(n = ifelse(is.na(n), "Excluded", n))
...
rq1_2_age_tests <- rq1_2_age_tests %>% mutate(n = ifelse(is.na(n), "Excluded", n))
...
rq1_2_gender <- rq1_2_gender %>% mutate(n = ifelse(is.na(n), "Excluded", n))
...
fig <- barplot_stacked_custom_q4(data = rq1_2_gender_tests %>% filter(type == 'All'),
                              x_var = 'sex_cd',
                              y_var = "value",
                              group_var = "tests",  # Grouping variable
                              x_label = "Gender",
                              y_label = "Percentage",
                              plot_title = "COVID-19 Tests Distribution by Gender",
                              legend_title = 'Number of tests',
...
```{r rq1 gender boxplot2 positive}
#| echo: false
#| warning: false
#| error: false
#| fig-column: page-right
...
fig <- barplot_stacked_custom_q4(data = rq1_2_gender_tests %>% filter(type == 'Positives'),
                              x_var = 'sex_cd',
                              y_var = "value",
                              group_var = "tests",  # Grouping variable
                              x_label = "Gender",
                              y_label = "Percentage",
                              plot_title = "COVID-19 Positive Tests Distribution by Gender",
                              legend_title = 'Number of tests',
                              x_axis_order = plotOrderSex)
fig
...
rq1_2_gender_tests <- rq1_2_gender_tests %>% mutate(n = ifelse(is.na(n), "Excluded", n))
...
rq1_2_gender_tests_table <- setNames(rq1_2_gender_tests[, names(new_col_names)], new_col_names)

datatable(rq1_2_gender_tests_table,
          filter = "top",
          options = list(pageLength = 8, class = 'row-border stripe hover compact'),
          rownames = FALSE,
          autoHideNavigation = TRUE, escape = FALSE) %>%
...
rq3_choropleth_map2 <- function(dataRQ, color) {
  custom_palette <- colorNumeric(palette = color, domain = dataRQ$mean, na.color = "lightgrey")
  ...
  map <- leaflet(dataRQ) %>%
    ...
    addPolygons(data = dataRQ %>% filter(type == 'All'),
                ...
                label = ~paste(
                  ...
                  "Name:<span style='color: green; font-weight: bold;'>", NUTS_NAME, "</span><br/>",
                  "n: ", n, "<br/>",
                  "All tests:<span style='color: black; font-weight: bold;'>", round(mean, 2), "%</span><br/>",
                  "</div>"
                ) %>% lapply(htmltools::HTML),
                group = "All") %>%
    addPolygons(data = dataRQ %>% filter(type == 'Positives'),
                ...
                label = ~paste(
                  ...
                  "Name: <span style='color: green; font-weight: bold;'>", NUTS_NAME, "</span><br/>",
                  "n: ", n, "<br/>",
                  "Positives tests:<span style='color: black; font-weight: bold;'>", round(mean, 2), "%</span><br/>",
                  "</div>"
                ) %>% lapply(htmltools::HTML),
                group = "Positives") %>%
    addLegend(
      ...
      title = "Average PCR Tests",
      labFormat = labelFormat(suffix = "%"),
      opacity = 1
    ) %>%
    addLayersControl(baseGroups = c("All", "Positives"),
                     options = layersControlOptions(collapsed = FALSE))
...
map <- rq3_choropleth_map2(rq1_2_area_nuts2_with_geometry, "viridis")
map
...
rq1_2_area_nuts2 <- rq1_2_area_nuts2 %>% mutate(n = ifelse(is.na(n), "Excluded", n))
...
rq3_choropleth_map2 <- function(dataRQ, color) {
  custom_palette <- colorNumeric(palette = color, domain = dataRQ$value, na.color = "lightgrey")

  map <- leaflet(dataRQ) %>%
    addProviderTiles(providers$CartoDB.Positron) %>%
    addPolygons(data = dataRQ %>% filter(tests == '0'),
                fillColor = ~custom_palette(value),
                fillOpacity = 0.7,
                weight = 1,
                opacity = 1,
                dashArray = "5, 5",
                ...
                label = ~paste(
                  ...
                  "Name:<span style='color: green; font-weight: bold;'>", NUTS_NAME, "</span><br/>",
                  "n: ", n, "<br/>",
                  "0 test:<span style='color: black; font-weight: bold;'>", round(value, 2), "%</span><br/>",
                  "</div>"
                ) %>% lapply(htmltools::HTML),
                group = "0 test") %>%
    addPolygons(data = dataRQ %>% filter(tests == '1 to 5'),
                fillColor = ~custom_palette(value),
                fillOpacity = 0.7,
                weight = 1,
                opacity = 1,
                ...
                label = ~paste(
                  ...
                  "Name: <span style='color: green; font-weight: bold;'>", NUTS_NAME, "</span><br/>",
                  "n: ", n, "<br/>",
                  "1 to 5 tests:<span style='color: black; font-weight: bold;'>", round(value, 2), "%</span><br/>",
                  "</div>"
                ) %>% lapply(htmltools::HTML),
                group = "1 to 5 tests") %>%
    addPolygons(data = dataRQ %>% filter(tests == 'more than 5'),
                fillColor = ~custom_palette(value),
                fillOpacity = 0.7,
                weight = 1,
                opacity = 1,
                ...
                label = ~paste(
                  ...
                  "Name: <span style='color: green; font-weight: bold;'>", NUTS_NAME, "</span><br/>",
                  "n: ", n, "<br/>",
                  "more than 5 tests:<span style='color: black; font-weight: bold;'>", round(value, 2), "%</span><br/>",
                  "</div>"
                ) %>% lapply(htmltools::HTML),
                group = "more than 5 tests") %>%
    addLegend(
      position = "bottomright",
      pal = custom_palette,
      values = ~dataRQ$value[!is.na(dataRQ$value)],
      title = "Distribution (%)",
      labFormat = labelFormat(suffix = "%"),
      opacity = 1
    ) %>%
    addLayersControl(baseGroups = c("0 test", "1 to 5 tests", "more than 5 tests"),
                     options = layersControlOptions(collapsed = FALSE))
...
map <- rq3_choropleth_map2(rq1_2_area_nuts2_tests_with_geometry, "viridis")
map
...
rq1_2_area_nuts2_tests <- rq1_2_area_nuts2_tests %>% mutate(n = ifelse(is.na(n), "Excluded", n))
...
map <- rq3_choropleth_map2(rq1_2_area_nuts3_with_geometry, "viridis")
map
...
rq1_2_area_nuts3 <- rq1_2_area_nuts3 %>% mutate(n = ifelse(is.na(n), "Excluded", n))
...
map <- rq3_choropleth_map2(rq1_2_area_nuts3_tests_with_geometry, "viridis")
map
...
rq1_2_area_nuts3_tests <- rq1_2_area_nuts3_tests %>% mutate(n = ifelse(is.na(n), "Excluded", n))
...
rq1_2_area_lau <- rq1_2_area_lau %>% mutate(n = ifelse(is.na(n), "Excluded", n))
...
rq1_2_area_lau2_tests <- rq1_2_area_lau2_tests %>% mutate(n = ifelse(is.na(n), "Excluded", n))
...
rq3_summary <- rq3_summary %>% mutate(n = ifelse(is.na(n), "Excluded", n))
...
rq3_education_aggreg <- rq3_education_aggreg %>% mutate(n = ifelse(is.na(n), "Excluded", n))
...
rq3_education_doses <- rq3_education_doses %>% mutate(n = ifelse(is.na(n), "Excluded", n))
...
rq3_income_aggreg <- rq3_income_aggreg %>% mutate(n = ifelse(is.na(n), "Excluded", n))
...
rq3_income_doses <- rq3_income_doses %>% mutate(n = ifelse(is.na(n), "Excluded", n))
...
rq3_migration_aggreg <- rq3_migration_aggreg %>% mutate(n = ifelse(is.na(n), "Excluded", n))
...
rq3_migration_doses <- rq3_migration_doses %>% mutate(n = ifelse(is.na(n), "Excluded", n))
...
rq3_household_aggreg <- rq3_household_aggreg %>% mutate(n = ifelse(is.na(n), "Excluded", n))
...
rq3_household_doses <- rq3_household_doses %>% mutate(n = ifelse(is.na(n), "Excluded", n))
...
rq3_age_aggreg <- rq3_age_aggreg %>% mutate(n = ifelse(is.na(n), "Excluded", n))
...
rq3_age_doses <- rq3_age_doses %>% mutate(n = ifelse(is.na(n), "Excluded", n))
...
fig <- barplot_custom(data = rq3_gender_aggreg %>% filter(fully_vaccinated_bl == TRUE),
                              x_var = 'sex_cd',
                              y_var = 'overall',
                              x_label = "Gender",
                              y_label = "Percentage",
                              plot_title = "COVID-19 vaccination rate by Gender",
                              legend_title = 'Status',
                              x_axis_order = plotOrderSex)
fig
...
p1_plotly <- barplot_stacked_custom_q4(data = rq3_gender_aggreg,
                                       x_var = "sex_cd",
                                       y_var = "subgroup",
                                       group_var = "fully_vaccinated_bl",
                                       x_label = "Gender",
...
rq3_gender_aggreg <- rq3_gender_aggreg %>% filter(fully_vaccinated_bl == TRUE)

rq3_gender_aggreg <- rq3_gender_aggreg %>% mutate(n = ifelse(is.na(n), "Excluded", n))
...
rq3_gender_table <- setNames(rq3_gender_aggreg[, names(new_col_names)], new_col_names)
...
fig <- barplot_stacked_custom_q4(data = rq3_gender_doses,
                              x_var = 'sex_cd',
                                       y_var = "value",
                                       group_var = "doses",  # Grouping variable
                              x_label = "Gender",
                              y_label = "Percentage",
                              plot_title = "Distribution of COVID-19 vaccine doses by Gender",
                              legend_title = 'Number of doses',
                              x_axis_order = plotOrderSex)
fig
...
rq3_gender_doses <- rq3_gender_doses %>% mutate(n = ifelse(is.na(n), "Excluded", n))
...
rq3_gender_doses_table <- setNames(rq3_gender_doses[, names(new_col_names)], new_col_names)

datatable(rq3_gender_doses_table,
          filter = "top",
          options = list(pageLength = 8, class = 'row-border stripe hover compact'),
          rownames = FALSE,
          autoHideNavigation = TRUE, escape = FALSE) %>%
...
rq3_choropleth_map <- function(dataRQ, color) {
  custom_palette <- colorNumeric(palette = color, domain = dataRQ$overall, na.color = "lightgrey")
  
  map <- leaflet(dataRQ) %>%
    addProviderTiles(providers$CartoDB.Positron) %>%
    addPolygons(data = dataRQ %>% select(-subgroup), 
                fillColor = ~custom_palette(overall), 
                fillOpacity = 0.7,
                weight = 1, 
                opacity = 1, 
                dashArray = "5, 5", 
                ...
                label = ~paste(
                  ...
                  "Name:<span style='color: green; font-weight: bold;'>", NUTS_NAME, "</span><br/>",
                  "n: ", n, "<br/>",
                  "Vaccination:<span style='color: black; font-weight: bold;'>", round(overall, 2), "%</span><br/>",
                  "</div>"
                ) %>% lapply(htmltools::HTML),
                group = "In Whole cohort") %>%
    addLegend(
      position = "bottomright",
      pal = custom_palette, 
      values = ~dataRQ$overall[!is.na(dataRQ$overall)],
      title = "Vaccination (%)",
      labFormat = labelFormat(suffix = "%"),
      opacity = 1
    )
...
map <- rq3_choropleth_map(rq3_area_nuts2_with_geometry, "viridis")
map
...
rq3_choropleth_map <- function(dataRQ, color) {
  custom_palette <- colorNumeric(palette = color, domain = dataRQ$subgroup, na.color = "lightgrey")
  
  map <- leaflet(dataRQ) %>%
    addProviderTiles(providers$CartoDB.Positron) %>%
    addPolygons(data = dataRQ %>% select(-overall), 
                fillColor = ~custom_palette(subgroup), 
                fillOpacity = 0.7,
                weight = 1, 
                opacity = 1, 
                dashArray = "5, 5", 
                ...
                label = ~paste(
                  ...
                  "Name:<span style='color: green; font-weight: bold;'>", NUTS_NAME, "</span><br/>",
                  "n: ", n, "<br/>",
                  "Vaccination:<span style='color: black; font-weight: bold;'>", round(subgroup, 2), "%</span><br/>",
                  "</div>"
                ) %>% lapply(htmltools::HTML),
                group = "In Whole cohort") %>%
    addLegend(
      position = "bottomright",
      pal = custom_palette, 
      values = ~dataRQ$subgroup[!is.na(dataRQ$subgroup)],
      title = "Vaccination (%)",
      labFormat = labelFormat(suffix = "%"),
      opacity = 1
    )
...
rq3_choropleth_map2 <- function(dataRQ, color) {
  ...
  map <- leaflet(dataRQ) %>%
    addProviderTiles(providers$CartoDB.Positron) %>%
    addPolygons(data = dataRQ %>% filter(doses == '0'),
                fillColor = ~custom_palette(value),
                fillOpacity = 0.7,
                weight = 1,
                opacity = 1,
                ...
                label = ~paste(
                  ...
                  "Name:<span style='color: green; font-weight: bold;'>", NUTS_NAME, "</span><br/>",
                  "n: ", n, "<br/>",
                  "0 dose:<span style='color: black; font-weight: bold;'>", round(value, 2), "%</span><br/>",
                  "</div>"
                ) %>% lapply(htmltools::HTML),
                group = "0 dose") %>%
    addPolygons(data = dataRQ %>% filter(doses == '1'),
                fillColor = ~custom_palette(value),
                fillOpacity = 0.7,
                weight = 1,
                opacity = 1,
                ...
                label = ~paste(
                  ...
                  "Name: <span style='color: green; font-weight: bold;'>", NUTS_NAME, "</span><br/>",
                  "n: ", n, "<br/>",
                  "1 dose:<span style='color: black; font-weight: bold;'>", round(value, 2), "%</span><br/>",
                  "</div>"
                ) %>% lapply(htmltools::HTML),
                group = "1 dose") %>%
    addPolygons(data = dataRQ %>% filter(doses == '2 or more'),
                fillColor = ~custom_palette(value),
                fillOpacity = 0.7,
                weight = 1,
                opacity = 1,
                ...
                label = ~paste(
                  ...
                  "Name: <span style='color: green; font-weight: bold;'>", NUTS_NAME, "</span><br/>",
                  "n: ", n, "<br/>",
                  "2 or more doses:<span style='color: black; font-weight: bold;'>", round(value, 2), "%</span><br/>",
                  "</div>"
                ) %>% lapply(htmltools::HTML),
                group = "2 or more doses") %>%
    addLegend(
      position = "bottomright",
      pal = custom_palette,
      values = ~dataRQ$value[!is.na(dataRQ$value)],
    ...
    addLayersControl(baseGroups = c("0 dose", "1 dose", "2 or more doses"),
                     options = layersControlOptions(collapsed = FALSE))
...
map <- rq3_choropleth_map2(rq3_area_nuts2_doses_with_geometry, "viridis")
map
...
rq3_area_nuts2 <- rq3_area_nuts2 %>% mutate(n = ifelse(is.na(n), "Excluded", n))
...
map <- rq3_choropleth_map(rq3_area_nuts3_with_geometry, "viridis")
map
...
rq3_area_nuts3 <- rq3_area_nuts3 %>% mutate(n = ifelse(is.na(n), "Excluded", n))
...
map <- rq3_choropleth_map2(rq3_area_nuts3_doses_with_geometry, "viridis")
map
...
rq3_area_lau2 <- rq3_area_lau2 %>% mutate(n = ifelse(is.na(n), "Excluded", n))
...
rq4_summary <- rq4_summary %>% mutate(n = ifelse(is.na(n), "Excluded", n))
...
rq4_education_aggreg <- rq4_education_aggreg %>% mutate(n = ifelse(is.na(n), "Excluded", n))
...
rq4_income_aggreg <- rq4_income_aggreg %>% mutate(n = ifelse(is.na(n), "Excluded", n))
...
rq4_migration_aggreg <- rq4_migration_aggreg %>% mutate(n = ifelse(is.na(n), "Excluded", n))
...
rq4_household_aggreg <- rq4_household_aggreg %>% mutate(n = ifelse(is.na(n), "Excluded", n))
...
rq4_age_aggreg <- rq4_age_aggreg %>% mutate(n = ifelse(is.na(n), "Excluded", n))
...
barplot_grouped_custom1(data1 = rq4_gender_aggreg %>% filter(cohort == "All"),
                        x_var1 = "sex_cd",
                        y_var1 = "overall",
                        data2 = rq4_gender_aggreg %>% filter(cohort == "Vaccinated"),
                        x_var2 = "sex_cd",
                        y_var2 = "overall",
                        data3 = rq4_gender_aggreg %>% filter(cohort == "Unvaccinated"),
                        x_var3 = "sex_cd",
                        y_var3 = "overall",
                        x_label = "Gender",
                        y_label = "Percentage",
...
p1_plotly <- barplot_stacked_custom_q4(data = rq4_gender_aggreg %>% filter(cohort == "All"),
                                    x_var = "sex_cd",
                                    y_var = "subgroup",
                                    group_var = "hospi_due_to_covid_bl",  # Grouping variable
                                    x_label = "Gender",
...
```{r rq4 gender barplot stacked 2}
#| echo: false
#| warning: false
#| error: false
#| fig-column: page-right
...
p1_plotly <- barplot_stacked_custom_q4(data = rq4_gender_aggreg %>% filter(cohort == "Vaccinated"),
                                    x_var = "sex_cd",
                                    y_var = "subgroup",
                                    group_var = "hospi_due_to_covid_bl",  # Grouping variable
                                    x_label = "Gender",
...
```{r rq4 gender barplot stacked 3}
#| echo: false
#| warning: false
#| error: false
#| fig-column: page-right
...
p1_plotly <- barplot_stacked_custom_q4(data = rq4_gender_aggreg %>% filter(cohort == "Unvaccinated"),
                                    x_var = "sex_cd",
                                    y_var = "subgroup",
                                    group_var = "hospi_due_to_covid_bl",  # Grouping variable
                                    x_label = "Gender",
...
# Ensure all combinations of NUTS_ID and cohort exist
expanded_df <- rq4_gender_aggreg %>%
  select(sex_cd) %>%
  distinct() %>%
  crossing(cohort = c("All", "Vaccinated", "Unvaccinated"))

# Join with the existing data
rq4_gender_aggreg <- expanded_df %>%
  left_join(rq4_gender_aggreg, join_by("sex_cd", "cohort")) %>% filter(hospi_due_to_covid_bl == TRUE)

rq4_gender_aggreg <- rq4_gender_aggreg %>% mutate(n = ifelse(is.na(n), "Excluded", n))
...
rq4_gender_aggreg_table <- setNames(rq4_gender_aggreg[, names(new_col_names)], new_col_names)

datatable(rq4_gender_aggreg_table, 
          filter = "top", 
          options = list(pageLength = 8, class = 'row-border stripe hover compact'), 
          rownames = FALSE, 
          autoHideNavigation = TRUE, escape = FALSE) %>%
...
rq4_choropleth_map <- function(dataRQ, color) {
  ...
  map <- leaflet(dataRQ) %>%
    addProviderTiles(providers$CartoDB.Positron) %>%
    addPolygons(data = dataRQ %>% filter(cohort == 'All'), 
                fillColor = ~custom_palette(overall), 
                fillOpacity = 0.7,
                weight = 1, 
                opacity = 1, 
                ...
                label = ~paste(
                  ...
                  "Name:<span style='color: green; font-weight: bold;'>", NUTS_NAME, "</span><br/>",
                  "n: ", n, "<br/>",
                  "Hospitalisation:<span style='color: black; font-weight: bold;'>", round(overall, 2), "%</span><br/>",
                  "</div>"
                ) %>% lapply(htmltools::HTML),
                group = "In Whole cohort") %>%
    addPolygons(data = dataRQ %>% filter(cohort == 'Vaccinated'), 
                fillColor = ~custom_palette(overall), 
                fillOpacity = 0.7,
                weight = 1, 
                opacity = 1, 
    ...
    addPolygons(data = dataRQ %>% filter(cohort == 'Unvaccinated'), 
                fillColor = ~custom_palette(overall), 
                fillOpacity = 0.7,
                weight = 1, 
                opacity = 1, 
    ...
    addLayersControl(baseGroups = c("In Whole cohort", "Vaccinated cohort", "Unvaccinated cohort"),
                     options = layersControlOptions(collapsed = FALSE))
...
map <- rq4_choropleth_map(rq4_area_nuts2_with_geometry, "viridis")
map
  ...
  map <- leaflet(dataRQ) %>%
    ...
    addPolygons(data = dataRQ %>% filter(cohort == 'All'), 
                ...
                label = ~paste(
                  ...
                  "Name:<span style='color: green; font-weight: bold;'>", NUTS_NAME, "</span><br/>",
                  "n: ", n, "<br/>",
                  "Hospitalisation:<span style='color: black; font-weight: bold;'>", round(subgroup, 2), "%</span><br/>",
                  "</div>"
                ) %>% lapply(htmltools::HTML),
                group = "In Whole cohort") %>%
    addPolygons(data = dataRQ %>% filter(cohort == 'Vaccinated'), 
...
rq4_area_nuts2 <- rq4_area_nuts2 %>% mutate(n = ifelse(is.na(n), "Excluded", n))
...
map <- rq4_choropleth_map(rq4_area_nuts3_with_geometry, "viridis")
map
...
rq4_area_nuts3 <- rq4_area_nuts3 %>% mutate(n = ifelse(is.na(n), "Excluded", n))
...
rq4_area_lau2 <- rq4_area_lau2 %>% mutate(n = ifelse(is.na(n), "Excluded", n))
