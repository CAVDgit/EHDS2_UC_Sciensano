...
extract_group_summary <- function(rq_df, rq_label, cohort_label) {
  ...
  data.frame(
    ...
    individuals_with_vaccine = extracted_values_group[11],
    avg_dose_nm = extracted_values_group[12],
    median_dose_nm = extracted_values_group[13],
    sd_dose_nm = extracted_values_group[14],  # SD for doses
    iqr_dose_nm = extracted_values_group[15],  # IQR for doses
    
    # Vaccination and hospitalization rates
    fully_vaccinated_count = extracted_values_group[16],
    vaccination_rate = extracted_values_group[17],
    hospitalised_true = extracted_values_group[18],
    hospitalisation_rate = extracted_values_group[19],
...
colnames(global_metrics_df) <- c(
  ...
  "Hospitalization Rate (%)"  # hospitalisation_rate
)
