...
extract_group_summary <- function(rq_df, rq_label, cohort_label) {
  ...
  data.frame(
    ...
    individuals_with_tests = extracted_values_group[3],
    avg_test_nm = extracted_values_group[4],
    individuals_with_vaccine = extracted_values_group[5],
    avg_dose_nm = extracted_values_group[6],
    fully_vaccinated_count = extracted_values_group[7],
    vaccination_rate = extracted_values_group[8],
    hospitalised_true = extracted_values_group[9],
    hospitalisation_rate = extracted_values_group[10],
...
colnames(global_metrics_df) <- c(
  ...
  "COVID-19 Hospitalized",        # hospitalised_true
  "Hospital Rate (%)"    # hospitalisation_rate
)
...
# List of columns that can be chosen for the Y-axis
y_axis_choices <- colnames(filtered_general_table)[!colnames(filtered_general_table) %in% c("Group")]
